...
void main() {
  group("Todo Repo Hive update test", () {
    ...
    test("repo todo update", () async {
      await hiveRepo.insert(Task.initial(id: "id", title: "title"));
      var data = await hiveRepo.update(
          "id", Task.initial(id: "id", title: "title_new"));
